...
class Settings_SMSNotifier_Edit_View extends Settings_Vtiger_IndexAjax_View {
	...
	public function process(Vtiger_Request $request) {
		...
		if ($recordId) $recordModel = Settings_SMSNotifier_Record_Model::getInstanceById($recordId, $qualifiedModuleName);
		else $recordModel = Settings_SMSNotifier_Record_Model::getCleanInstance($qualifiedModuleName);
